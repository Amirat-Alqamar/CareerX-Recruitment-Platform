            ...
            <div className="hidden lg:flex lg:w-5/12 bg-[#00B7B5] p-12 flex-col justify-between text-white relative overflow-hidden">
                ...
                <div className="my-auto max-w-md">
                    <p className="text-2xl font-medium leading-relaxed mb-6">
                        "TalentFlow helped me land my dream job at a top tech company in just 3 weeks. The platform is incredibly intuitive."
                    </p>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-white/80">UX Designer at Google</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 pt-8 border-t border-white/20">
                    <div>
                        ...
                        <div className="text-xs text-white/80">Jobs Listed</div>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="text-xs text-white/80">Match Rate</div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex-1 flex flex-col justify-between p-6 sm:p-12">
                <div className="max-w-md w-full mx-auto my-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-sm text-gray-500 mt-1">Sign in to your TalentFlow account</p>
                    </div>

                    {/* Social Login Buttons */}
                    <div className="grid grid-cols-2 gap-3 mb-6">
                        <button type="button" className="flex items-center justify-center gap-2 py-2 px-4 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition">
                    ...
                    <div className="relative flex items-center justify-center mb-6">
                        ...
                        <span className="bg-white px-3 text-xs text-gray-400 absolute">or continue with email</span>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center justify-between text-xs">
                            ...
                            <Link href="/forgot-password" className="font-semibold text-gray-700 hover:text-[#00B7B5]">Forgot password?</Link>
                        </div>

                        <button
                            type="submit"
                            disabled={processing}
                            className="w-full py-3 bg-[#00B7B5] hover:bg-[#009b99] text-white font-semibold rounded-xl text-sm flex items-center justify-center gap-2 transition duration-200 shadow-sm"
                        >
                            Sign In
                    ...
                    <p className="text-center text-xs text-gray-500 mt-6">
                        Don't have an account? <Link href="/register" className="font-semibold text-[#00B7B5] hover:underline">Create account</Link>
                    </p>
                </div>

                <div className="flex justify-center gap-6 text-xs text-gray-400 mt-6">
                    <Link href="#" className="hover:text-gray-600">Sign in as Company →</Link>
                    <Link href="#" className="hover:text-gray-600">Admin Portal →</Link>
                </div>
            </div>
        </div>
    );
